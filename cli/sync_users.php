 ...
 * Sample cron entry:
 * # 5 minutes past 4am
 * 5 4 * * * sudo -u www-data /usr/bin/php /var/www/moodle/auth/dbparent/cli/sync_users.php
 *
 * Notes:
...
The auth_dbparent plugin must be enabled and properly configured.
...
Example:
\$ sudo -u www-data /usr/bin/php auth/dbparent/cli/sync_users.php
...
if (!is_enabled_auth('dbparent')) {
    cli_error('auth_dbparent plugin is disabled, synchronisation stopped', 2);
}
...
/** @var auth_plugin_dbparent $dbauth */
$dbauth = get_auth_plugin('dbparent');
